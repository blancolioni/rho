...
package body Rho.Demos.Cone is

   type Cone_Demo_Type is
   ...
   type Cone_Demo_Access is access all Cone_Demo_Type;
   ...
   overriding procedure Execute
     (Demo   : not null access Cone_Demo_Type;
      Handle : Rho.Handles.Handle;
      Window : Rho.Windows.Window_Type);
   ...
   is
      ...
      Geometry : constant Rho.Geometry.Geometry_Type :=
                   Rho.Geometry.Cone.Cone_Geometry (1.0, 1.0, 32, 16);
   ...
   is
      ...
      Demo : constant Cone_Demo_Access :=
   ...
   begin
      Demo.Holder.Look_At
        (Rho.Matrices.To_Vector
           (Real (Data.X) - 500.0, Real (Data.Y) - 400.0, 1000.0));
